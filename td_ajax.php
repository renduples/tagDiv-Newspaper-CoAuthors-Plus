			...
			switch ($ajax_parameters['td_atts']['td_ajax_filter_type']) {
				...
				case 'td_custom_related':
					if ($ajax_parameters['td_filter_value'] == 'td_related_more_from_author') {
						...
						$coAuthors = get_coauthors_posts( $ajax_parameters['td_atts']['live_filter_cur_post_id'], $ajax_parameters['td_atts']['limit'], $ajax_parameters['td_current_page']);
						$td_query->posts = $coAuthors['posts'];
						$td_query->found_posts = $coAuthors['posts_found'];
    					$td_query->max_num_pages = $coAuthors['posts_found'] / $ajax_parameters['td_atts']['limit'];
					}
					break;
			}
		}
