        ...
        <div class="td-author-counters">
            <span class="td-author-post-count">
                <?php 
                    ...
                    // https://github.com/Automattic/Co-Authors-Plus/blob/master/co-authors-plus.php
                    if ( function_exists( 'get_coauthors_posts' ) ) {
                        if ($part_cur_auth_obj->postcount == 1) {
                            echo $part_cur_auth_obj->postcount . ' ARTICLE';
                        } else {
                            echo $part_cur_auth_obj->postcount . ' ARTICLES';
                        }
                    } else {
            ...
            if ( function_exists( 'get_coauthors_posts' ) ) {
                ...
                foreach (td_social_icons::$td_social_icons_array as $td_social_id => $td_social_name) {
                    if($td_social_id == 'twitter') {
                        $authorMeta = $part_cur_auth_obj->twitter;
                        if (!empty($authorMeta)) {
