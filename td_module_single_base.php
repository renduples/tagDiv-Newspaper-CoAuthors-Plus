    ...
    function get_author() {
        ...
        if (td_util::get_option('tds_p_show_author_name') != 'hide') {
            ...
            if ( function_exists( 'coauthors_posts_links' ) ) {
                $buffy .= coauthors_posts_links_by_id($this->post->ID, $between = ', ', $betweenLast = ' & ', $before = null, $after = null, $echo = false);
            } else {
        ...
        if ( function_exists( 'coauthors_posts_links' ) ) {
            ...
            if (empty($hideAuthor)) {
                ...
                foreach ($coAuthors as $key => $author) {
                    ...
                    $buffy .= '<a href="' . $author->website . '">' ;
                    $buffy .= coauthors_get_avatar( $author, '96' );
                    $buffy .= '</a>';


                    $buffy .= '<div class="desc">';
                    $buffy .= '<div class="td-author-name vcard author"><span class="fn">';
                    $buffy .= '<a href="' . $author->website . '">' . $author->display_name . '</a>' ;
                    $buffy .= '</span></div>';

                    if ($author->website != '') {
                        $buffy .= '<div class="td-author-url"><a href="' . $author->website . '">More Articles by this Author</a></div>';
                    }

                    $buffy .= '<div class="td-author-description">';
                    $buffy .=  $author->description;
                    $buffy .= '</div>';
